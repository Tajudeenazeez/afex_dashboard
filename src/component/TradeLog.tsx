...
const rows = [
  createData('Soybeans (SSBS)', 'X-Traded', 'Buy', 1792.65, 9265, '17 Oct, 2020', '07:34'),
  createData('Paddy Rice (SPRL)', 'X-Traded', 'Buy',1792.65, 9265, '8 Sep, 2020', '02:02'),
  createData('Maize(SMAZ)', 'OTC', 'Sell',1792.65, 9265, '24, May, 2020','06:42'),
  createData('Sorghum (SSGM)', 'FI', 'Sell',1792.65, 9265, '1 Feb, 2020','01:09'),
  createData('Fair Trade', 'FI', 'Sell',1792.65, 9265, '15 Jan, 2023', '08:04'),
  createData('Fair Trade(FETC)', 'FI', 'Sell',1792.65, 9265, '24, Jan, 2023', "06:90"),
];
